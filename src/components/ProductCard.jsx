...
const ProductCard = ({ data }) => {
  ...
  return (
    <div className="w-[200px] h-[200px] relative m-2 rounded-md ">
      ...
      <div className="absolute left-0 bottom-0 bg-yellow-600 text-white w-full px-2 rounded-b-md">
      ...
      {openEdit && (
        <div className="z-0 absolute top-0 right-0 w-full h-full flex items-center justify-around text-sm bg-black border border-white text-white bg-opacity-30 rounded-md">
          <div
