...
import { ascendDataFunc, descendDataFunc } from "../redux/dataSlice";
const Header = () => {
  const dispatch = useDispatch();
  const [sortingOpt, setSortingOpt] = useState('');
    ...
    <div className="flex items-center justify-between bg-indigo-600 text-white px-4 py-3">
      ...
      <div className="flex items-center gap-5">
        <div className="text-black">
          <select className="h-10 rounded-lg" name="" id="" onChange={handleChange}>
